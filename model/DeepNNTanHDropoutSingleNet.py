...
class DeepNNTanHDropoutSingleNet(ModelInterface):
    
    def __init__(self, n_in, n_out, state_bounds, action_bounds, reward_bound, settings_):

        super(DeepNNTanHDropoutSingleNet,self).__init__(n_in, n_out, state_bounds, action_bounds, reward_bound, settings_)
